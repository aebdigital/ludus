                    ...
                    <div className="space-y-6 max-w-xl mx-auto lg:mx-0">
                        ...
                        <div className="grid grid-cols-2 gap-y-8 gap-x-12 py-8 border-t border-black/10 mt-8">
                            ...
                            {(event.age_badge || event.age_info) && (
                                <div className="col-span-2 border-t border-black/10 pt-4 mt-2">
                                    <span className="block text-xs opacity-50 uppercase tracking-widest mb-2">Vekové odporúčanie</span>
                ...
                <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-20">
                    ...
                    <div className="space-y-12">
                        ...
                        {event.cast_members && event.cast_members.length > 0 && (
                            <div>
                                <h3 className="text-xl font-bold font-heading mb-4 border-b border-black pb-2" style={{ fontFamily: 'var(--font-heading)' }}>
                                    Obsadenie
                                </h3>
                    ...
                    <div className="space-y-12">
                        {relatedEvents.length > 0 && (
                            <div>
                                <h3 className="text-xl font-bold font-heading mb-6 border-b border-black pb-2" style={{ fontFamily: 'var(--font-heading)' }}>
                                    Program
                                </h3>
