...
export const metadata: Metadata = {
    title: "Program predstavení",
    description: "Aktuálny program predstavení a podujatí Divadla a Školy LUDUS v Bratislave. Rezervujte si lístky na naše najbližšie inscenácie.",
};
