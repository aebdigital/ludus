    ...
    return (
        <>
            <section
                ...
                style={{ backgroundImage: "url('/images/divadlo-main.webp')" }} // Using divadlo image
            >
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        <p className="text-[1.1rem] text-[#000] font-bold mb-2">
                                            Občianske združenie DIVADLO LUDUS
                                        </p>
                                        <p className="text-[1.1rem] text-[#000]">
                                            Palackého 22, 81102, Bratislava<br />
                                            <strong>IČO:</strong> 31795188
                                        </p>
                                    </div>
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            ...
            <div className="form-group hidden">
                <input type="hidden" name="subject" value="divadlo-ludus" />
            </div>
            <div className="form-group">
