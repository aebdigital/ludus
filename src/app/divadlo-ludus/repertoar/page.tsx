...
export const metadata: Metadata = {
    title: "Repertoár divadla",
    description: "Aktuálny repertoár Divadla LUDUS. Objavte naše inscenácie pre deti a mládež, od klasiky až po súčasné autorské predstavenia.",
};
...
export default async function RepertoarPage() {
    ...
    return (
        <>
            <section
                className="h-[40vh] max-md:h-[20vh] bg-cover bg-[center_30%] flex items-center justify-center relative overflow-hidden mt-20 max-md:mt-13 "
