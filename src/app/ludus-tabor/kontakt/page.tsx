...
import TaborKontaktClient from './TaborKontaktClient';
import MapSection from '@/components/MapSection';

export const metadata: Metadata = {
    title: "Kontakt | LUDUS Tábor",
    description: "Máte otázky k letnému táboru LUDUS? Kontaktujte nás. Radi vám poskytneme všetky potrebné informácie o termínoch a programe.",
};
