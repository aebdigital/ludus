...
export default function KnihaClient() {
    ...
    return (
        <main className="w-[95%] mx-auto py-16">
            {/* Book Intro */}
            <div className="bg-[#07793f] text-white p-12 max-md:p-4 rounded-3xl shadow-2xl mb-24 grid grid-cols-[500px_1fr] gap-20 items-stretch max-lg:grid-cols-1">
            ...
            <div className="bg-[#1a1a1a] text-white p-12 max-md:p-4 rounded-xl shadow-2xl mb-8 grid grid-cols-[1fr_300px_400px] gap-8 items-center max-xl:grid-cols-1">
                <div>
