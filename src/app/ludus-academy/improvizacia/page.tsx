                        ...
                        <div className="mb-24">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="bg-white border-2 border-[#269fab] p-8 max-md:p-4 max-md:pt-10 rounded-2xl relative overflow-hidden flex flex-col">
                                        <div className="absolute top-0 right-0 bg-[#269fab] text-white px-4 py-1 font-bold text-xs uppercase">TERMÍN</div>
                                    ...
                                    <div className="bg-white border-2 border-[#269fab] p-8 max-md:p-4 max-md:pt-10 rounded-2xl relative overflow-hidden flex flex-col">
                                        ...
                                        <div className="mb-8">
                                            <span className="text-sm uppercase text-black font-bold">Lektori</span>
                                            <LektorCards lektori={[
                                                { name: 'Mgr. art Ladislav Ladomirjak', image: '/pedagogovia/Laci Ladomirjak.webp' },
                                                { name: 'Mgr. art Jozef Jurčišin-Kukľa', image: '/pedagogovia/JOŽKO JURČIŠIN KUKLA.webp' }
                                            ]} />
