...
export const metadata: Metadata = {
    title: "Blog | LUDUS Academy",
    description: "Články o divadle, improvizácii a tvorivom myslení. Zdieľame tipy a inšpirácie pre váš umelecký a osobný rast.",
};
    ...
    return (
        <>
            ...
            <section
                ...
                style={{ backgroundImage: "url('/images/academy/IMG_9026.webp')", backgroundPosition: 'center 25%' }}
            >
