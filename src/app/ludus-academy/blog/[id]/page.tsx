...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
    ...
    if (!post) {
        return {
            title: 'Článok nenájdený | LUDUS Academy',
        };
    }

    return {
        title: `${post.title} | LUDUS Academy Blog`,
        description: post.preview || "Článok o divadle, improvizácii a tvorivom myslení v LUDUS Academy.",
    };
}
