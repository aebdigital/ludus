...
export default async function WorkshopySkolyPage() {
 ...
 <div className="group bg-white border border-gray-100 p-8 max-md:p-3 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300">
 <div className="text-[#d66420] font-bold mb-2 uppercase tracking-tighter">RADOSŤ SPOLU PRACOVAŤ</div>
 ...
 <div className="group bg-white border border-gray-100 p-8 max-md:p-3 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300">
 <div className="text-[#d66420] font-bold mb-2 uppercase tracking-tighter">RADOSŤ ĽAHŠIE ŠTUDOVAŤ</div>
 ...
 {/* RADOSŤ SPOLU TVORIŤ */}
 <div className="group bg-white border border-gray-100 p-8 max-md:p-3 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300">
 <div className="text-[#d66420] font-bold mb-2 uppercase tracking-tighter">RADOSŤ SPOLU TVORIŤ</div>
 ...
 <div className="group bg-white border border-gray-100 p-8 max-md:p-3 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300">
 <div className="text-[#d66420] font-bold mb-2 uppercase tracking-tighter">RADOSŤ SPOLU IMPROVIZOVAŤ</div>
