                    ...
                    <main className="flex-1 min-w-0">
                        <div className="mb-24">
                            <h2 className="text-[3rem] mb-2 text-black leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                                RADOSŤ <span className="text-[#d66420]">SA</span> SPOZNÁVAŤ
                            </h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                                <div className="bg-[#d66420] p-8 max-md:p-3 rounded-2xl shadow-xl">
                                    <h3 className="text-[1.5rem] mb-6 text-white font-bold uppercase" style={{ fontFamily: 'var(--font-heading)' }}>Čo workshopmi môžete získať:</h3>
                                ...
                                <div className="bg-white p-8 max-md:p-3 rounded-2xl border-2 border-[#d66420]/30">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-[#269fab] text-white flex items-center justify-center font-bold">1</div>
                                            <p className="font-medium text-black">4 typy workshopov</p>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-[#269fab] text-white flex items-center justify-center font-bold">2</div>
                                            <p className="font-medium text-black">2 hod. (120 min) alebo 3 hod. (180 min)</p>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-[#269fab] text-white flex items-center justify-center font-bold">3</div>
                            ...
                            <div className="bg-[#269fab] text-white p-10 max-md:p-4 rounded-2xl mb-24 shadow-xl">
                                <div className="text-black font-bold uppercase tracking-widest mb-2 text-sm text-center">Cena workshopu</div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
                                    <div className="bg-white/5 p-6 rounded-xl border border-white/10 text-center">
                                        ...
                                        <p className="text-black text-[2.5rem] font-bold">130 EUR</p>
                                    ...
                                    <div className="bg-white/5 p-6 rounded-xl border border-white/10 text-center">
                                        ...
                                        <p className="text-black text-[2.5rem] font-bold">160 EUR</p>
                                        <p className="text-white/40 text-xs">pre jednu triedu</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="group bg-[#d66420] p-8 max-md:p-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 text-white">
                                    <div className="text-white font-bold mb-2 uppercase tracking-tighter opacity-90">RADOSŤ SPOLU PRACOVAŤ</div>
                                    <h4 className="text-[1.8rem] mb-4 text-white leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>Spolupráca a tímový duch</h4>
                                    <p className="text-white/90 mb-6 leading-relaxed text-[1.05rem]">
                                    ...
                                    <div className="mt-auto pt-6 border-t border-white/20 text-sm font-bold text-white">
                                        Vhodný od 5.triedy ZŠ a pre SŠ
                                    </div>
                                </div>

                                {/* RADOSŤ ĽAHŠIE ŠTUDOVAŤ */}
                                <div className="group bg-[#269fab] p-8 max-md:p-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 text-white">
                                    <div className="text-white font-bold mb-2 uppercase tracking-tighter opacity-90">RADOSŤ ĽAHŠIE ŠTUDOVAŤ</div>
                                    <h4 className="text-[1.8rem] mb-4 text-white leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>Efektívne učenie</h4>
                                    <p className="text-white/90 mb-6 leading-relaxed text-[1.05rem]">
                                ...
                                {/* RADOSŤ SPOLU TVORIŤ */}
                                <div className="group bg-[#269fab] p-8 max-md:p-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 text-white">
                                    <div className="text-white font-bold mb-2 uppercase tracking-tighter opacity-90">RADOSŤ SPOLU TVORIŤ</div>
                                    <h4 className="text-[1.8rem] mb-4 text-white leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>Kreatívne riešenia</h4>
                                    <p className="text-white/90 mb-6 leading-relaxed text-[1.05rem]">
                                ...
                                <div className="group bg-[#d66420] p-8 max-md:p-4 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 text-white">
                                    <div className="text-white font-bold mb-2 uppercase tracking-tighter opacity-90">RADOSŤ SPOLU IMPROVIZOVAŤ</div>
                                    <h4 className="text-[1.8rem] mb-4 text-white leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>Flexibilita a nápady</h4>
                                    <p className="text-white/90 mb-6 leading-relaxed text-[1.05rem]">
                            ...
                            <div className="mt-24 bg-[#269fab] text-white p-12 max-md:p-5 rounded-2xl text-center shadow-2xl relative overflow-hidden group">
                                ...
                                <p className="text-white mb-8 max-w-2xl mx-auto relative z-10 text-[1.1rem]">
