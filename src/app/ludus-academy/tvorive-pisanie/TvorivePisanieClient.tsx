...
export default function TvorivePisanieClient() {
        ...
        <main className="flex-1 min-w-0">
            ...
            <div className="mb-24">
                <h2 className="text-[3rem] mb-2 text-black leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                    RADOSŤ <span className="text-[#139d54]">vedieť</span> PÍSAŤ
                </h2>
                <div className="text-[#139d54] font-bold text-[1.2rem] mb-8 uppercase tracking-widest leading-tight">
                ...
                <div className="flex gap-12 max-lg:flex-col mb-12">
                    <div className="flex-[0.7] text-[1.1rem] text-[#000] space-y-6 leading-relaxed">
                        <p className="italic font-light text-black border-l-4 border-[#139d54] pl-6 py-2">
                ...
                <div className="bg-[#139d54] p-10 max-md:p-4 rounded-2xl mb-12 shadow-xl">
                ...
                <div className="bg-[#139d54] text-white p-10 max-md:p-4 rounded-2xl mb-12 shadow-xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-white">
                        ...
                        <ul className="space-y-2 text-sm">
                            <li className="flex gap-2 items-center"><span className="text-[#139d54]">•</span> Profesionálny lektor so skúsenosťami</li>
                            <li className="flex gap-2 items-center"><span className="text-[#139d54]">•</span> Individuálny prístup</li>
                            <li className="flex gap-2 items-center"><span className="text-[#139d54]">•</span> Rôzne tvorivé metódy písania</li>
                            <li className="flex gap-2 items-center"><span className="text-[#139d54]">•</span> Káva and čaj počas kurzu</li>
                            <li className="flex gap-2 items-center"><span className="text-[#139d54]">•</span> Certifikát</li>
                        </ul>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {lectors.map((member) => {
                            ...
                            return (
                                <div
                                    key={member.name}
                                    className={`bg-white rounded-xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-all duration-300 hover:-translate-y-2 ${canOpen ? 'cursor-pointer hover:shadow-xl ring-2 ring-transparent hover:ring-[#139d54]/50 group' : ''}`}
                                ...
                                >
                                    <div className="aspect-[3/4] relative bg-gray-100 overflow-hidden">
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 z-10 p-4 bg-gradient-to-t from-black/70 to-transparent">
                                            ...
                                            <p className="text-[#139d54] font-bold text-xs uppercase tracking-wider drop-shadow-lg">{member.role}</p>
                                        </div>
                                        {canOpen && (
                ...
                <div className="space-y-12 mb-12">
                    ...
                    <div className="bg-[#139d54]/5 p-12 max-md:p-5 rounded-3xl border border-[#139d54]/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                        <div className="bg-white border-2 border-[#139d54] p-10 max-md:p-4 max-md:pt-12 rounded-2xl relative overflow-hidden flex flex-col">
                            <div className="absolute top-0 right-0 bg-[#139d54] text-white px-6 py-2 font-bold uppercase tracking-widest">TERMÍN</div>
