    ...
    return (
        <>
            <section
                ...
                style={{ backgroundImage: "url('/images/logo-academy-main.jpeg')" }} // Using academy image
            >
                            ...
                            <div className="bg-white p-8 rounded-xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 h-fit">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[1.1rem] text-[#000]">
                                            <a href="mailto:info@ludusacademy.sk" className="hover:text-[#ffd37c] block">info@ludusacademy.sk</a>
                                            <a href="tel:0947942125" className="hover:text-[#ffd37c] block">0947 942 125</a>
                                        </p>
                                    </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            ...
            <div className="form-group">
                ...
                <select
                    ...
                    required
                    disabled={loading}
                    className="w-full p-3 rounded border border-gray-200 focus:border-[#ffd37c] outline-none transition-colors bg-white"
                >
