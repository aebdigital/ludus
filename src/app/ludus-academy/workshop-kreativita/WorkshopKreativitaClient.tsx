...
export default function WorkshopKreativitaClient() {
            ...
            <div className="mb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <div className="p-8 bg-[#269fab] text-white rounded-2xl shadow-xl">
                        ...
                        <div className="space-y-4 text-white">
                            <p>Workshop kreatívneho myslenia je určený pre všetkých, ktorí chcú objaviť alebo rozvíysť svoju kreativitu – bez ohľadu na vek, profesiu či skúsenosti.</p>
                ...
                <div className="bg-[#149951] p-10 max-md:p-4 rounded-2xl mb-12 shadow-xl">
                    <p className="mb-6 leading-relaxed text-white">
                        ...
                        Budeme pracovať s metódami ako <strong className="text-white">synektika, analógia, metafora, metóda šiestich mysliacich klobúkov, improvizácia, či zmyslové vnímanie</strong>.
                ...
                <div className="bg-[#269fab] text-white p-10 max-md:p-4 rounded-2xl mb-12 shadow-xl">
                    ...
                    <h3 className="text-[2rem] mb-8 leading-tight">
