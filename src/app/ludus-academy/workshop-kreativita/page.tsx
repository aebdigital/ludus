                        ...
                        <div className="mb-24">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                                <div className="p-8 bg-black text-white rounded-2xl shadow-xl">
                                    <h3 className="text-[1.5rem] mb-4 text-[#ffd37c] font-bold uppercase" style={{ fontFamily: 'var(--font-heading)' }}>Pre koho je workshop určený?</h3>
                            ...
                            <div className="bg-white border border-[#ffd37c]/20 p-10 rounded-2xl mb-12 shadow-[0_10px_40px_rgba(0,0,0,0.03)]">
                                ...
                                <div className="mt-12">
                                    ...
                                    <div className="bg-gray-50 border border-gray-100 p-8 rounded-xl space-y-4">
                                        <p className="flex gap-3"><span className="text-[#ffd37c] font-bold">•</span> Po absolvovaní workshopu budete kreatívnejší a schopnejší riešiť problémy originálnejším spôsobom.</p>
                                        <p className="flex gap-3"><span className="text-[#ffd37c] font-bold">•</span> Naučíte sa, ako rozvíjať svoju tvorivosť v každodennom živote, práci aj medziľudských vzťahoch.</p>
                                        <p className="flex gap-3"><span className="text-[#ffd37c] font-bold">•</span> Získate praktické nástroje a techniky, ktoré vám pomôžu rozvíjať kreativitu aj po skončení workshopu.</p>
                                        <p className="flex gap-3"><span className="text-[#ffd37c] font-bold">•</span> Stačí sa odvážiť skúšať, hrať sa a objavovať!</p>
                                        <p className="flex gap-3"><span className="text-[#ffd37c] font-bold">•</span> Zistíte, kde sú vaše silné stránky, kde máte limity a čo s nimi môžete robiť.</p>
                                        <p className="flex gap-3 font-bold text-black"><span className="text-[#ffd37c]">•</span> Posuniete svoje kreatívne myslenie na vyššiu úroveň a naučíte sa pracovať so svojím potenciálom.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-black text-white p-10 rounded-2xl mb-12 shadow-xl">
                                <div className="text-[#ffd37c] font-bold uppercase tracking-widest mb-2 text-sm text-center">Investícia</div>
                                <h3 className="text-[2rem] mb-8 text-center leading-tight">
                                    NEKUPUJETE SI WORKSHOP, INVESTUJETE DO SVOJHO ROZVOJA: <span className="text-[#ffd37c]">119 EUR</span>
                                </h3>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-gray-300">
                                    ...
                                    <ul className="space-y-2 text-sm">
                                        <li className="flex gap-2 items-center"><span className="text-[#ffd37c]">•</span> Profesionálna lektorka MgA. Baranová</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#ffd37c]">•</span> Kreatívne metódy a techniky</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#ffd37c]">•</span> Občerstvenie: ovocie, káva, čaj</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#ffd37c]">•</span> Certifikát o absolvovaní</li>
                                    </ul>
                                </div>
                            ...
                            <div className="bg-white border-2 border-[#ffd37c] p-10 rounded-2xl mb-12 relative overflow-hidden text-center">
                            ...
                            <div className="bg-gray-900 text-white p-12 rounded-3xl mt-24 relative overflow-hidden">
                                <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[#ffd37c]/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>
                                <div className="flex gap-12 items-center max-md:flex-col">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <Button href="/ludus-academy/kniha" className="bg-[#ffd37c] text-black border-none hover:bg-white">Viac o knihe</Button>
                                    </div>
                                </div>
                            </div>
                        </div>
