                    ...
                    <main className="flex-1 min-w-0">
                        <div className="mb-24">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                                <div className="bg-[#d66420] p-10 max-md:p-4 rounded-2xl shadow-xl flex flex-col justify-center">
                                    ...
                                    <ul className="space-y-3">
                                        {[
                                            ...
                                            <li key={i} className="flex gap-3 items-start text-black">
                            ...
                            <div className="bg-[#066831] p-10 max-md:p-4 rounded-2xl mb-16 shadow-xl text-white">
                                <h3 className="text-[2rem] mb-8 text-white text-center" style={{ fontFamily: 'var(--font-heading)' }}>
                                    Čo môžete získať
                                </h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-3 items-center bg-white/10 p-4 rounded-xl shadow-sm border border-white/10">
                                            <span className="w-6 h-6 rounded-full bg-white flex items-center justify-center text-[#066831] text-xs font-bold">✓</span>
                                            <span className="text-[1rem] font-medium text-white">{benefit}</span>
                                        </div>
                                    ))}
                                </div>
                                <p className="mt-8 text-center text-white/80 italic">
                            ...
                            <div className="bg-[#d66420] text-white p-12 max-md:p-5 rounded-2xl text-center shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="flex gap-4 justify-center relative z-10 max-sm:flex-col max-sm:items-center">
                                    ...
                                    <Button
                                        ...
                                        className="!bg-[#066831] !text-white !border-[#066831] hover:!bg-[#055628] px-10 py-4 text-lg"
                                    >
                                        0947 942 125
                                    </Button>
                                </div>
