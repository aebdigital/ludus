...
export default async function HereckyKurzPage() {
 ...
 RADOSŤ <span className="text-[#e79b2c]">SA</span> HRAŤ
 </h2>
 <div className="flex flex-wrap gap-x-4 gap-y-1 text-[#e79b2c] font-bold text-[1.2rem] mb-8 uppercase tracking-widest">
 ...
 <div className="bg-white border-2 border-[#e79b2c] p-8 max-md:p-3 rounded-2xl relative overflow-hidden flex flex-col">
 <div className="absolute top-0 right-0 bg-[#e79b2c] text-black px-4 py-1 font-bold text-xs uppercase">HERECKÝ KURZ - TEAMBUILDING</div>
 <div className="flex items-center gap-2 mb-2">
 <span className="bg-[#e79b2c] text-black px-2 py-0.5 rounded text-[0.7rem] font-bold">TERMÍN</span>
 ...
 <div>
 <h2 className="text-[3rem] mb-2 text-black leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
 Herecký kurz pre pokročilých: RADOSŤ <span className="text-[#e79b2c]">SA</span> HRAŤ
 </h2>
 ...
 <div className="w-8 h-8 rounded-full bg-[#e79b2c] flex items-center justify-center font-bold text-white shrink-0">?</div>
