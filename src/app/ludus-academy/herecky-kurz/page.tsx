    ...
    return (
        <div className="bg-white">
            <section
                ...
                style={{
                    backgroundImage: "url('/images/academy/IMG_1128.webp')",
                    ...
                    <main className="flex-1 min-w-0">
                        ...
                        <div className="mb-24">
                            <h2 className="text-[3rem] mb-2 text-black leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                                RADOSŤ <span className="text-[#149951]">SA</span> HRAŤ
                            </h2>
                            <div className="flex flex-wrap gap-x-4 gap-y-1 text-[#149951] font-bold text-[1.2rem] mb-8 uppercase tracking-widest">
                            ...
                            <div className="bg-[#e79b2c] p-10 max-md:p-4 rounded-2xl shadow-xl mb-12">
                                <h3 className="text-[1.8rem] mb-8 text-white" style={{ fontFamily: 'var(--font-heading)' }}>
                            ...
                            <div className="bg-[#149951] text-white p-10 max-md:p-4 rounded-2xl mb-12 shadow-xl">
                                ...
                                <h3 className="text-[2rem] mb-6 leading-tight">
                                    NEKUPUJETE SI KURZ, INVESTUJETE DO SVOJHO ROZVOJA: <span className="text-black">348 EUR</span>
                                </h3>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-white">
                                    ...
                                    <ul className="space-y-2">
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> 27,5 hodín intenzívnej výučby + záverečné vystúpenie</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Individuálny prístup</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Herecké cvičenia a techniky</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Profesionálni lektori</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Záverečné vystúpenie v divadelnom štúdiu</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Certifikát</li>
                                    </ul>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                                <div className="bg-white border-2 border-[#149951] p-8 max-md:p-4 max-md:pt-10 rounded-2xl relative overflow-hidden flex flex-col">
                                    <div className="absolute top-0 right-0 bg-[#149951] text-white px-4 py-1 font-bold text-xs uppercase">HERECKÝ KURZ - TEAMBUILDING</div>
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="bg-[#149951] text-white px-2 py-0.5 rounded text-[0.7rem] font-bold">TERMÍN</span>
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <LektorCards lektori={[
                                            { name: 'Mgr. art Michal Rovňák', image: '/pedagogovia/MICHAL ROVŇÁK.webp' },
                                            { name: 'Mgr. art Miroslava Durná ArtD.', image: '/pedagogovia/MIRKA DURNÁ.webp' }
                                        ]} />
                                    </div>
                                    <div className="mt-auto">
                                        <Button
                                            href="https://form.fapi.cz/?id=8a85a30a-6cd8-4bfd-8844-b468ad175c8f"
                                            className="w-full justify-center !bg-[#149951] !text-white hover:!bg-[#0f7a3f]"
                                            target="_blank"
                                        >
                                            PRIHLÁSIŤ SA
                                        </Button>
                                ...
                                <div className="bg-white border-2 border-[#149951] p-8 max-md:p-4 max-md:pt-10 rounded-2xl relative overflow-hidden flex flex-col">
                                    <div className="absolute top-0 right-0 bg-[#149951] text-white px-4 py-1 font-bold text-xs uppercase">HERECKÝ KURZ - DVERE</div>
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="bg-[#149951] text-white px-2 py-0.5 rounded text-[0.7rem] font-bold">TERMÍN</span>
                                    ...
                                    <div className="mb-8">
                                        <span className="text-sm uppercase text-black font-bold">Lektori</span>
                                        <LektorCards lektori={[
                                            { name: 'Mgr. art Jozef Jurčišin-Kukľa', image: '/pedagogovia/JOŽKO JURČIŠIN KUKLA.webp' },
                                            { name: 'Bc. Richard Labuda', image: '/pedagogovia/RICHARD LABUDA.webp' }
                                        ]} />
                                    </div>
                                    <div className="mt-auto">
                                        <Button
                        ...
                        <div>
                            <h2 className="text-[3rem] mb-2 text-black leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                                Herecký kurz pre pokročilých: RADOSŤ <span className="text-[#149951]">SA</span> HRAŤ
                            </h2>
                            <div className="text-[#149951] font-bold text-[1.1rem] mb-2 uppercase tracking-wide">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                                {[
                                    ...
                                    <div key={i} className="p-4 bg-[#e79b2c] rounded-xl border border-[#e79b2c] flex items-center gap-4 group hover:bg-white hover:border-[#e79b2c] transition-all">
                                        <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center font-bold text-black shrink-0 shadow-sm">?</div>
                                        <p className="text-[0.95rem] font-bold text-black">{question}</p>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="bg-[#149951] text-white p-10 max-md:p-4 rounded-2xl mb-12 shadow-xl">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-white">
                                    ...
                                    <ul className="space-y-2">
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> 27,5 hodín intenzívnej výučby + záverečné vystúpenie</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Individuálny prístup</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Herecké cvičenia a techniky, práca na dialógoch</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Profesionálni lektori</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Záverečné vystúpenie v divadelnom štúdiu</li>
                                        <li className="flex gap-2 items-center"><span className="text-[#e79b2c]">•</span> Certifikát</li>
                                    </ul>
