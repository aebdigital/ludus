...
export default function PrihlaskaClient() {
    return (
        <>
            <section
            ...
            <div className="w-[95%] mx-auto py-12">
                <div className="grid grid-cols-[1.5fr_1fr] gap-12 max-lg:grid-cols-1">
                    ...
                    <div>
                        {/* Info Section */}
                        <div className="bg-white p-12 max-md:p-6 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.1)] mb-12">
                            <h2
                        ...
                        <div className="bg-gray-50 p-12 max-md:p-6 rounded-xl border-2 border-dashed border-gray-300 text-center">
                    ...
                    <div className="space-y-8">
                        {/* Konkurz Info */}
                        <div className="bg-[#f47f44] p-8 max-md:p-4 rounded-xl text-black">
                            <h2
