    ...
    return (
        <div className="bg-[#fcfcfc] min-h-screen">
            ...
            <section
                ...
                style={{
                    backgroundImage: "url('/images/divadlo-main.webp')",
            ...
            <div className="w-[95%] max-w-7xl mx-auto pt-20 pb-0">
                ...
                <div className="space-y-16 mb-32">
                    <div className="max-w-5xl mx-auto text-center px-4">
                        <h3
                            className="text-black text-[2.5rem] lg:text-[3rem] font-bold uppercase tracking-widest leading-tight"
                            style={{ fontFamily: "var(--font-heading)" }}
                        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-16 items-start">
                        {founders.map((founder, index) => (
                            <div
                                key={index}
                                className="flex flex-col sm:flex-row gap-8 items-start text-left"
                            >
                                ...
                                <div className="flex-1 w-full">
                                    <h3
                                        className="text-[2rem] leading-none mb-6 text-black"
                                        style={{ fontFamily: "var(--font-heading)" }}
                                    >
                                        {founder.name}
                                    </h3>
                                        ...
                                        <div>
                                            ...
                                            <ul className="space-y-1 list-none p-0">
                                                {founder.pastRoles.map((role, idx) => (
                                                    <li
                                                        key={idx}
                                                        className="flex items-start gap-3 pl-4 border-l-2 border-[#f47f44]/30"
                                                    >
                        ...
                        >
                            <div className="aspect-video w-full rounded-xl overflow-hidden shadow-lg bg-black relative flex items-center justify-center p-8 text-center transition-all group-hover:bg-[#f47f44]/10">
                                <div className="border border-white/20 p-8 rounded-lg w-full h-full flex flex-col items-center justify-center gap-4">
                                    <p className="text-white font-heading text-2xl group-hover:text-[#f47f44]">
                                        Dokument Fenomén LUDUS
                                    </p>
                                    <span className="text-white/60 text-sm">
                                        Pozrieť v archíve STVR
                                    </span>
                                </div>
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <span className="bg-[#f47f44] text-black px-6 py-2 rounded-full font-bold">
                                        Otvoriť archív →
                                    </span>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto space-y-24">
                    <div className="grid grid-cols-[1fr_450px] gap-12 items-center max-lg:grid-cols-1">
                        <div className="bg-white p-12 max-md:p-4 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-gray-100 italic">
                        ...
                        <div className="relative">
                            <Image
                                ...
                                width={600}
                                height={800}
                                className="w-full h-[600px] max-md:h-[300px] object-cover rounded-2xl shadow-xl"
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-[450px_1fr] gap-12 items-center max-lg:grid-cols-1">
                        ...
                        <div className="space-y-8 text-[1.2rem] leading-relaxed text-[#000]">
                            <p>
                                ...
                                priestory na Rezedovej ulici – s vlastnou divadelnou sálou.
                                Úroveň predstavení sa tým posunula na ešte vyššiu úroveň.
                                Inscenácie, ktorých interpretmi boli žiaci Ludusu, už
                    ...
                    <div className="grid grid-cols-[1fr_450px] gap-12 items-start max-lg:grid-cols-1">
                        ...
                        <div className="relative">
                            <Image
                                ...
                                width={600}
                                height={800}
                                className="w-full h-[500px] max-md:h-[250px] object-cover rounded-2xl shadow-xl"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div className="w-[95%] max-w-[1600px] mx-auto pb-32">
                <h2
                    className="text-[3rem] mt-32 max-md:mt-16 mb-16 text-center"
                    style={{ fontFamily: "var(--font-heading)" }}
                >
                    Divadelná produkcia
                </h2>
                <div className="space-y-24">
                    <div>
                        ...
                        <div className="bg-white p-12 max-md:p-4 rounded-3xl shadow-sm border border-gray-100 text-base text-left">
                            <CollapsibleList
                                items={[
