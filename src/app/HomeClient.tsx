...
interface HomeClientProps {
    aktuality: AktualityItem[];
    upcomingEvents: EventItem[];
}

export default function HomeClient({ aktuality, upcomingEvents }: HomeClientProps) {
        ...
        <div className="flex flex-col">
            ...
            <main className="flex h-[50vh] w-[calc(100%-2rem)] max-md:w-[95%] mx-auto p-4 max-md:px-0 gap-4 max-md:gap-2 max-md:flex-col max-md:h-auto order-1 md:order-1 mt-2 md:mt-10 max-md:mt-13">
                <IntroSection
                    ...
                    logoText={['Súkromná', 'Základná', 'Umelecká', 'Škola']}
                    logoAlt="Logo Škola Ludus"
                />
