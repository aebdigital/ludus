            ...
            <section className="py-16 bg-white text-black">
                <div className="w-[95%] md:w-[80%] mx-auto text-lg leading-relaxed space-y-8">
                    ...
                    <div className="bg-gray-50 p-8 rounded-xl border border-gray-200">
                        ...
                        <p><strong>E-mail:</strong> <a href="mailto:info@skolaludus.sk" className="underline hover:text-[#ffd37c]">info@skolaludus.sk</a></p>
                        <p><strong>Tel.:</strong> <a href="tel:+421905543282" className="underline hover:text-[#ffd37c]">+421 905 543 282</a></p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            ...
                            <button onClick={() => window.openCookieSettings?.()} className="underline hover:text-[#ffd37c] font-semibold">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li>Podanie sťažnosti u Úradu na ochranu osobných údajov SR (Hraničná 12, 820 07 Bratislava, <a href="https://www.dataprotection.gov.sk" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#ffd37c]">www.dataprotection.gov.sk</a>)</li>
                        </ul>
                        <p className="mt-4">
                            V prípade otázok alebo uplatnenia Vašich práv nás môžete kontaktovať na{' '}
                            <a href="mailto:info@skolaludus.sk" className="underline hover:text-[#ffd37c]">info@skolaludus.sk</a>
                            {' '}alebo telefónnom čísle{' '}
                            <a href="tel:+421905543282" className="underline hover:text-[#ffd37c]">+421 905 543 282</a>.
                        </p>
                    </div>
