...
export default function Sidebar({ category }: SidebarProps) {
    ...
    return (
        <aside className="max-xl:order-first sticky top-[100px] w-full max-w-[320px] bg-[#1eabb0] p-8 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] h-fit max-lg:max-w-none max-lg:static max-md:mb-4">
            <h3
