...
export default function PriceCard({
  ...
  return (
    <div className="bg-white p-12 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] text-center flex flex-col justify-between transition-all duration-300 border border-transparent hover:-translate-y-1 hover:border-[#ffd37c]">
      <div>
        <h3
